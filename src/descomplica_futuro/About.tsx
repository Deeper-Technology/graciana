    ...
    return (
        <section className="md:p-16 py-30 max-md:pb-20 bg-white justify-center items-center flex max-md:flex-col gap-16">
            ...
            <span className="flex flex-col max-md:w-[85%] w-[40%] gap-6">
                ...
                <button onClick={() => window.open('https://api.whatsapp.com/send/?phone=5551993579849&type=phone_number&app_absent=0')} className="w-max bg-[#4955D4] mt-6 rounded-xl px-10 py-[0.62rem] text-center items-center justify-center cursor-pointer hover:scale-105 duration-300 transition-transform">
